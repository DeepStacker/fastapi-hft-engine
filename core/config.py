...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = os.getenv("DATABASE_URL", "mysql+aiomysql://root:root@mysql:3306/test_db_optionchain") # Ensure password characters are URL-encoded if necessary (@ becomes %40)
