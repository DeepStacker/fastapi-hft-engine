...
- coa: Chart of Accuracy 9-scenario framework
- coa_alerts: COA alert subscriptions and notifications
...
from app.api.v1.analytics.coa import router as coa_router
from app.api.v1.analytics.coa_alerts import router as coa_alerts_router
...
router.include_router(coa_router, tags=["Analytics - Chart of Accuracy"])
router.include_router(coa_alerts_router, tags=["Analytics - COA Alerts"])
